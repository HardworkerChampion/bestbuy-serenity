...
import com.bestbuy.storesinfo.ProductsSteps;
...
public class ProductsCRUDTestWithSteps {
    ...
    @Title("This will verify if product is added")
    @Test
    public void test002(){
    ...
    @Title("This will Update and verify the product information ")
    @Test
    public void test003(){
        name = name + "_updated";
    ...
    @Title("This will delete the product and verify if the product is deleted")
    @Test
    public void test004(){
            steps.deleteProduct(productId);
